...
wget --no-check-certificate https://raw.githubusercontent.com/b0ts37en/t4k-hosting-solutions/master/installer/kynweb/dedi-series/kyneticweb-seedbox.zip
...
rm ports.conf
wget --no-check-certificate https://raw.githubusercontent.com/b0ts37en/t4k-hosting-solutions/master/installer/kynweb/dedi-series/ports.conf
...
echo "<?php \$streampath = 'https://$HOSTNAME.kyneticweb.com/stream/view.php'; ?>" | tee /var/www/rutorrent/plugins/mediastream/conf.php > /dev/null
...
wget --no-check-certificate https://raw.githubusercontent.com/b0ts37en/t4k-hosting-solutions/master/installer/kynweb/dedi-series/AutodlFilesDownloader.js
cd /var/www/rutorrent/js
rm webui.js
wget --no-check-certificate https://raw.githubusercontent.com/b0ts37en/t4k-hosting-solutions/master/installer/kynweb/dedi-series/webui.js
cd ..
chown -R www-data:www-data /var/www/rutorrent
chmod -R 755 /var/www/rutorrent
cd 
...
wget --no-check-certificate https://raw.githubusercontent.com/b0ts37en/t4k-hosting-solutions/master/installer/kynweb/dedi-series/ratiocolor.zip
...
wget --no-check-certificate https://raw.githubusercontent.com/b0ts37en/t4k-hosting-solutions/master/installer/kynweb/dedi-series/stream.zip
...
cd /tmp/
wget --no-check-certificate https://raw.githubusercontent.com/b0ts37en/t4k-hosting-solutions/master/installer/kynweb/dedi-series/divx611-20060201-gcc4.0.1.zip
unzip divx611-20060201-gcc4.0.1.zip
